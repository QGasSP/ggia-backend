...
# APARTMENT
def apartment_emission_calculator(df, country_code, emission_factors_df, start_year, unit_number):
    BUI_COL275 = df.BUI_COL275[country_code]
    BUI_COL51 = df.BUI_COL51[country_code]
    BUI_COL83 = df.BUI_COL83[country_code]

    # Electricity
    def GHG_electricitya(nraXa, nraAa, nraBa, BUI_COL275, BUI_COL51, BUI_COL83,
    ...
    def GHG_heata(nraXa, nraAa, nraBa, BUI_COL282, BUI_COL58, BUI_COL90,
                  DISTRICT_HEATING_emission_factora=350):
    ...
    def GHG_gasa(nraXa, nraAa, nraBa, BUI_COL276, BUI_COL52, BUI_COL84, BUI_COL1):
        gas = (((nraXa * BUI_COL276) + (nraAa * BUI_COL52) + (
                nraBa * BUI_COL84)) * BUI_COL1) / 1_000_000
        return gas
    ...
    def GHG_oila(nraXa, nraAa, nraBa, BUI_COL277, BUI_COL53, BUI_COL85, BUI_COL2):
        oil = (((nraXa * BUI_COL277) + (nraAa * BUI_COL53) + (
                nraBa * BUI_COL85)) * BUI_COL2) / 1_000_000
        return oil
    ...
    def GHG_coala(nraXa, nraAa, nraBa, BUI_COL278, BUI_COL54, BUI_COL86, BUI_COL3):
        coal = (((nraXa * BUI_COL278) + (nraAa * BUI_COL54) + (
                nraBa * BUI_COL86)) * BUI_COL3) / 1_000_000
        return coal
    ...
    def GHG_peata(nraXa, nraAa, nraBa, BUI_COL279, BUI_COL55, BUI_COL87, BUI_COL4):
        peat = (((nraXa * BUI_COL279) + (nraAa * BUI_COL55) + (
                nraBa * BUI_COL87)) * BUI_COL4) / 1_000_000
        return peat
    ...
    def GHG_wooda(nraXa, nraAa, nraBa, BUI_COL280, BUI_COL56, BUI_COL88, BUI_COL5):
        wood = (((nraXa * BUI_COL280) + (nraAa * BUI_COL56) + (
                nraBa * BUI_COL88)) * BUI_COL5) / 1_000_000
        return wood
    ...
    def GHG_renewablea(nraXa, nraAa, nraBa, BUI_COL281, BUI_COL57, BUI_COL89, BUI_COL6):
        renewabe = (((nraXa * BUI_COL281) + (nraAa * BUI_COL57) + (
                nraBa * BUI_COL89)) * BUI_COL6) / 1_000_000
        return renewabe
    ...
    for i in range(start_year, 2051):
        ...
        Heat = GHG_heata(nraXa, nraAa, nraBa, BUI_COL282, BUI_COL58, BUI_COL90,
